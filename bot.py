...
subreddit_name = "shitpostcrusaders"                 #Replace with your desired subreddit name
tag_string= "#shitpostcrusaders"        #Place to put your hastags, etc. Must be <=114 char
...
def setup_connection_reddit(subreddit):
	...
	r = praw.Reddit('reddit-twitter posting app'
...
def tweeter(post_titles, post_links, post_ids):
	...
	auth.set_access_token(access_token, access_sec_token)
	api = tweepy.API(auth)
	index=0
